 ...
 * @author Daniel
 */
@WebServlet(name = "PesquisarClientes", urlPatterns = {"/loja_server/PesquisarClientes"}, initParams = {
    @WebInitParam(name = "nomeUsuario", value = ""),
    @WebInitParam(name = "senha", value = ""),
    @WebInitParam(name = "nome", value = "")})
public class PesquisarClientes extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cod > 0) {
            ...
            ArrayList<ClienteBEAN> u = con.listarClietesPesquisa(nome);
